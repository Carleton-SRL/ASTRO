...
MAT_TEMPLATE matrixT operator ! (matrixT m) _THROW_MATRIX_ERROR;
...
public:
   ...
   // Logical operators
   friend bool operator == FRIEND_FUN_TEMPLATE (const matrixT& m1, const matrixT& m2) _NO_THROW;
   friend bool operator != FRIEND_FUN_TEMPLATE (const matrixT& m1, const matrixT& m2) _NO_THROW;

   // Calculation operators
   friend matrixT operator + FRIEND_FUN_TEMPLATE (const matrixT& m1, const matrixT& m2) _THROW_MATRIX_ERROR;
   friend matrixT operator - FRIEND_FUN_TEMPLATE (const matrixT& m1, const matrixT& m2) _THROW_MATRIX_ERROR;
   friend matrixT operator * FRIEND_FUN_TEMPLATE (const matrixT& m1, const matrixT& m2) _THROW_MATRIX_ERROR;
#if !defined(_MSC_VER) || _MSC_VER > 1020
   friend matrixT operator * FRIEND_FUN_TEMPLATE (const matrixT& m, const T& no) _NO_THROW;
   friend matrixT operator * FRIEND_FUN_TEMPLATE (const T& no, const matrixT& m) _NO_THROW;
#endif
   friend matrixT operator / FRIEND_FUN_TEMPLATE (const matrixT& m1, const matrixT& m2) _THROW_MATRIX_ERROR;
#if !defined(_MSC_VER) || _MSC_VER > 1020
   friend matrixT operator / FRIEND_FUN_TEMPLATE (const matrixT& m, const T& no) _NO_THROW;
   friend matrixT operator / FRIEND_FUN_TEMPLATE (const T& no, const matrixT& m) _THROW_MATRIX_ERROR;
#endif
   friend matrixT operator ~ FRIEND_FUN_TEMPLATE (const matrixT& m) _NO_THROW;
   friend matrixT operator ! FRIEND_FUN_TEMPLATE (matrixT m) _THROW_MATRIX_ERROR;
   friend matrixT operator ^ FRIEND_FUN_TEMPLATE (const matrixT& m, const size_t& pow) _THROW_MATRIX_ERROR;
   ...
   // Io-stream operators
   friend istream& operator >> FRIEND_FUN_TEMPLATE (istream& i, matrixT& m);
   friend ostream& operator << FRIEND_FUN_TEMPLATE (ostream& o, const matrixT& m);
