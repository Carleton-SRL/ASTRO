//////////////////////////////////////////////////////
// Matrix TCL Pro 2.11
// Copyright (c) 2000-2002 Techsoft Pvt. Ltd. All Rights Reserved.
// File name: Matrix.cc - Implementation of matrix class (don't include this file)
...
//
#ifndef __MWERKS__                  // Metrowerks CodeWarrior 6.0
...
operator<< (ostream &os, const matrix<T>& m)
{
    for (size_t i=0; i < m.rowno(); i++)
       for (size_t j=0; j < m.colno(); j++)
          os << m(i,j) << (j == m.colno()-1 ? MATRIX_ROW_SEP : MATRIX_COL_SEP);
   return os;
}
