function [r_Mercury,r_Venus,r_Earth,r_Mars,r_Jupiter,r_Saturn,r_Uranus, ...
          r_Neptune,r_Pluto,r_Moon,r_Sun,r_SunSSB,EMRAT1] = JPL_Eph_DE436(Mjd_TDB,PC)
...
r_Earth = 1e3*time_variables.Cheb3D(Mjd_TDB, 13, Mjd0, Mjd0+16, Cx_Earth(13*j+1:13*j+13),...
...
r_Moon = 1e3*time_variables.Cheb3D(Mjd_TDB, 13, Mjd0, Mjd0+4, Cx_Moon(13*j+1:13*j+13),...
...
r_Sun = 1e3*time_variables.Cheb3D(Mjd_TDB, 11, Mjd0, Mjd0+16, Cx_Sun(11*j+1:11*j+11),...
...
r_Mercury = 1e3*time_variables.Cheb3D(Mjd_TDB, 14, Mjd0, Mjd0+8, Cx_Mercury(14*j+1:14*j+14),...
...
r_Venus = 1e3*time_variables.Cheb3D(Mjd_TDB, 10, Mjd0, Mjd0+16, Cx_Venus(10*j+1:10*j+10),...
...
j=0;
Mjd0 = t1;
r_Mars = 1e3*time_variables.Cheb3D(Mjd_TDB, 11, Mjd0, Mjd0+32, Cx_Mars(11*j+1:11*j+11),...
...
j=0;
Mjd0 = t1;
r_Jupiter = 1e3*time_variables.Cheb3D(Mjd_TDB, 8, Mjd0, Mjd0+32, Cx_Jupiter(8*j+1:8*j+8),...
...
j=0;
Mjd0 = t1;
r_Saturn = 1e3*time_variables.Cheb3D(Mjd_TDB, 7, Mjd0, Mjd0+32, Cx_Saturn(7*j+1:7*j+7),...
...
j=0;
Mjd0 = t1;
r_Uranus = 1e3*time_variables.Cheb3D(Mjd_TDB, 6, Mjd0, Mjd0+32, Cx_Uranus(6*j+1:6*j+6),...
...
j=0;
Mjd0 = t1;
r_Neptune = 1e3*time_variables.Cheb3D(Mjd_TDB, 6, Mjd0, Mjd0+32, Cx_Neptune(6*j+1:6*j+6),...
...
j=0;
Mjd0 = t1;
r_Pluto = 1e3*time_variables.Cheb3D(Mjd_TDB, 6, Mjd0, Mjd0+32, Cx_Pluto(6*j+1:6*j+6),...
...
Nutations = time_variables.Cheb3D(Mjd_TDB, 10, Mjd0, Mjd0+8, Cx_Nutations(10*j+1:10*j+10),...
...
Librations = time_variables.Cheb3D(Mjd_TDB, 10, Mjd0, Mjd0+8, Cx_Librations(10*j+1:10*j+10),...
