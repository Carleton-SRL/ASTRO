function s = iauS06(date1, date2, x, y, ConstantParameters)
...
fa(1) = time_variables.iauFal03(t,ConstantParameters);

% Mean anomaly of the Sun.
fa(2) = time_variables.iauFalp03(t,ConstantParameters);

% Mean longitude of the Moon minus that of the ascending node.
fa(3) = time_variables.iauFaf03(t,ConstantParameters);

% Mean elongation of the Moon from the Sun.
fa(4) = time_variables.iauFad03(t,ConstantParameters);

% Mean longitude of the ascending node of the Moon.
fa(5) = time_variables.iauFaom03(t,ConstantParameters);

% Mean longitude of Venus.
fa(6) = time_variables.iauFave03(t,ConstantParameters);

% Mean longitude of Earth.
fa(7) = time_variables.iauFae03(t,ConstantParameters);

% General precession in longitude.
fa(8) = time_variables.iauFapa03(t);
...
s = (w0 + (w1 + (w2 + (w3 + (w4 + w5 * t) * t) * t) * t) * t) * ConstantParameters.DAS2R - x*y/2.0;
end
